      ...
      <div className="basis-0 bg-neutral-900 grow h-full min-h-px min-w-px relative shrink-0">
        <div className="flex flex-col items-center justify-center overflow-hidden relative size-full">
          <div className="box-border content-stretch flex flex-col items-center justify-center p-[40px] relative size-full">
            ...
            >
              <Skeleton className="h-10 w-32 bg-[#3d3d3d]" />
              <Skeleton className="h-10 w-32 bg-gradient-to-r from-[#5e97ff]/30 to-[#1738de]/30 rounded-lg" />
            </motion.div>
              ...
              {Array.from({ length: 8 }).map((_, i) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    <Skeleton className="h-16 w-16 rounded-full bg-[#3d3d3d]" />
                    <div className="flex-1">
                      <Skeleton className="h-5 w-24 bg-[#3d3d3d] mb-2" />
                      <Skeleton className="h-4 w-32 bg-[#3d3d3d] mb-1" />
                      <Skeleton className="h-4 w-16 bg-[#5e97ff]/30 rounded" />
                    </div>
                  </div>
                  
                  {/* Action Button */}
                  <div className="flex justify-end">
                    <Skeleton className="h-8 w-8 bg-[#3d3d3d] rounded" />
                  </div>
                </motion.div>
              ))}
            </motion.div>
