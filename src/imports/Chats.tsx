import svgPaths from "./svg-rqybbzeg0p";
  ...
  return (
    <div className="relative size-[16.903px]" data-name="close-circle">
      ...
      >
        <g id="close-circle">
          <g id="Vector">
            <path d={svgPaths.pccd6e80} fill="var(--fill-0, white)" />
            <path d={svgPaths.p27267400} fill="var(--fill-0, white)" />
          </g>
        </g>
      </svg>
    </div>
  ...
  return (
    ...
    >
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-start px-2.5 py-3 relative w-full">
          <div className="basis-0 flex flex-col font-['Lufga:Regular',_sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#ffffff] text-[14px] text-left text-nowrap">
            <p className="[text-overflow:inherit] [text-wrap-mode:inherit]\' [white-space-collapse:inherit] block leading-[normal] overflow-inherit">
...
function InfoCard1() {
  return (
    <div
      className="box-border content-stretch flex flex-row gap-8 items-center justify-center p-[2px] relative rounded-[30px] shrink-0"
      data-name="Info Card"
    >
      <Frame1000002401 />
    </div>
...
function Frame1000002423() {
  return (
    <div className="box-border content-stretch flex flex-row gap-2.5 items-end justify-end p-0 relative shrink-0 w-full">
      <Frame1000002422 />
      <InfoCard1 />
    </div>
  );
...
function InfoCard2() {
  return (
    <div
      className="box-border content-stretch flex flex-row gap-8 items-end justify-start p-0 relative rounded-[30px] shrink-0"
      data-name="Info Card"
    >
      <div
      ...
      <div className="flex flex-row items-center justify-center relative size-full">
        <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-center p-[16px] relative w-full">
          <div className="basis-0 font-['Lufga:Regular',_sans-serif] grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#ffffff] text-[16px] text-left">
            <p className="block leading-[1.5] mb-0">
            ...
            <p className="block leading-[1.5] mb-0">&nbsp;</p>
            <ol className="list-decimal" start="1">
              ...
              <li className="mb-0 ms-6">
                <span className="leading-[1.5]">
                  ...
                  analysis. This ability is particularly useful in complex
              ...
              <li className="mb-0 ms-6">
                <span className="leading-[1.5]">
                  Continuous operation: AI systems can work tirelessly without
                  the need for breaks, resulting in uninterrupted 24/7
...
function Frame1000002399() {
  return (
    <div className="basis-0 box-border content-stretch flex flex-col gap-5 grow items-end justify-start min-h-px min-w-px p-0 relative shrink-0 w-full">
      <Frame1000002423 />
      <Frame1000002424 />
    </div>
  );
